 ...
 */
final class Version20220307122837 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE editors (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, country VARCHAR(45) NOT NULL)');
        ...
        $this->addSql('CREATE TABLE games (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, releasedate DATE NOT NULL, description CLOB NOT NULL)');
        $this->addSql('CREATE TABLE games_has_platforms (id_game_id INTEGER NOT NULL, id_platform_id INTEGER NOT NULL, PRIMARY KEY(id_game_id, id_platform_id))');
        ...
        $this->addSql('CREATE TABLE plateforms (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, manufacturer VARCHAR(255) NOT NULL, model VARCHAR(45) NOT NULL)');
        $this->addSql('CREATE TABLE roles (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, role_name VARCHAR(45) NOT NULL)');
        $this->addSql('CREATE TABLE studios (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, country VARCHAR(45) NOT NULL)');
        ...
        , password VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, pseudo VARCHAR(255) NOT NULL, account_creation_user DATETIME NOT NULL --(DC2Type:datetime_immutable)
        ...
        $this->addSql('CREATE TABLE users_has_game_has_platforms (id_user_id INTEGER NOT NULL, id_game_id INTEGER NOT NULL, id_platform_id INTEGER NOT NULL, PRIMARY KEY(id_user_id, id_game_id, id_platform_id))');
        $this->addSql('CREATE INDEX IDX_7D10F95D79F37AE5 ON users_has_game_has_platforms (id_user_id)');
        $this->addSql('CREATE INDEX IDX_7D10F95D3A127075 ON users_has_game_has_platforms (id_game_id)');
        $this->addSql('CREATE INDEX IDX_7D10F95DE7F48498 ON users_has_game_has_platforms (id_platform_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE plateforms');
        $this->addSql('DROP TABLE roles');
        $this->addSql('DROP TABLE studios');
        $this->addSql('DROP TABLE studios_has_games');
        $this->addSql('DROP TABLE users');
        $this->addSql('DROP TABLE users_has_game_has_platforms');
