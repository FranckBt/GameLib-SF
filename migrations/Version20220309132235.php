 ...
 */
final class Version20220309132235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users (id INT AUTO_INCREMENT NOT NULL, id_role_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, name_user VARCHAR(255) NOT NULL, first_name_user VARCHAR(255) NOT NULL, pseudo VARCHAR(255) NOT NULL, accoun_creation_date_user DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', account_validation_user DATETIME DEFAULT NULL, bio_user LONGTEXT DEFAULT NULL, avatar_user VARCHAR(255) DEFAULT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_1483A5E9E7927C74 (email), INDEX IDX_1483A5E989E8BDC (id_role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
